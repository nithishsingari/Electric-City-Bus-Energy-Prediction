...
--
-- Host: localhost
-- Generation Time: Nov 09, 2023 at 02:17 PM
...
--
-- Database: `data_driven_energy_economy_prediction`
--
CREATE DATABASE IF NOT EXISTS `data_driven_energy_economy_prediction` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `data_driven_energy_economy_prediction`;
...
('7ou9wx66et9enuetzynxdwi37mve9s62', 'eyJ1c2VyaWQiOjJ9:1qrFkR:JIfgnYXoTedH0MHFGzsSqer0NidMWmXdjctDPiB7CxU', '2023-10-27 10:50:27.818103'),
...
('bgddxjdbjjtin07lhixhnj4afwpkqzl3', 'eyJ1c2VyaWQiOjF9:1pKGAz:RTTDg_LbvqO7DaaeGYvYpsGWacoP6pRClTXn0gHdWWc', '2023-02-07 10:05:13.222590'),
...
('ebcqak9e4nm4bjm5nwtclw9odrk743zl', 'eyJ1c2VyaWQiOjF9:1qrDBP:SCVtxDX6KE67_mt8ObAvtKZj4YxPwJuPOJjlXMC0kTo', '2023-10-27 08:06:07.958205'),
...
('h914yl87k5athtytuf0plp4le1rivlef', 'eyJ1c2VyaWQiOjJ9:1pKGa4:aQzVzS2a-GcPYQVCwMwsZkHex_hBhsFLQxyrwDDpZeI', '2023-02-07 10:31:08.985421'),
...
('xseu6prk5w1ner6jfwp6mkigxjcbifff', 'eyJ1c2VyaWQiOjF9:1pKGPW:fkAQdVJm4PNH8m7rR5Yg5Zr2w6td4HtN20vQ3_EHnT4', '2023-02-07 10:20:14.092514'),
...
(65, 'Naive Bayes', '40.909090909090914'),
(66, 'SVM', '31.818181818181817'),
(67, 'Logistic Regression', '31.818181818181817'),
(68, 'KNeighborsClassifier', '45.45454545454545'),
(69, 'Random Forest Classifier', '36.36363636363637'),
(70, 'Artificial Neural Network (RNN)', '40.909090909090914');
...
--
-- Table structure for table `remote_user_energy_economy_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_energy_economy_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(300) NOT NULL,
  `Brand` varchar(300) NOT NULL,
  `Model` varchar(300) NOT NULL,
  `AccelSec` varchar(300) NOT NULL,
  `TopSpeed_KmH` varchar(300) NOT NULL,
  `Range_Km` varchar(300) NOT NULL,
  `Efficiency_WhKm` varchar(300) NOT NULL,
  `FastCharge_KmH` varchar(300) NOT NULL,
  `RapidCharge` varchar(300) NOT NULL,
  `PowerTrain` varchar(300) NOT NULL,
  `PlugType` varchar(300) NOT NULL,
  `BodyStyle` varchar(300) NOT NULL,
  `Segment` varchar(300) NOT NULL,
  `Charging_Price` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=7 ;

--
-- Dumping data for table `remote_user_energy_economy_prediction`
--

INSERT INTO `remote_user_energy_economy_prediction` (`id`, `Fid`, `Brand`, `Model`, `AccelSec`, `TopSpeed_KmH`, `Range_Km`, `Efficiency_WhKm`, `FastCharge_KmH`, `RapidCharge`, `PowerTrain`, `PlugType`, `BodyStyle`, `Segment`, `Charging_Price`, `Prediction`) VALUES
(2, '10.42.0.151-66.102.255.61-38991-80-6', 'BYD Auto', 'ID.3 Pure', '10', '160', '270', '167', '250', 'Yes', 'RWD', 'Type 2 CCS', 'Hatchback', 'C', '30000', 'High'),
(3, '10.42.0.151-31.13.71.7-59286-443-6', 'Zhengzhou Yutong Bus Co., Ltd.', '2', '4.7', '210', '400', '181', '620', 'Yes', 'AWD', 'Type 2 CCS', 'Liftback', 'D', '56440', 'High'),
(4, '10.42.0.211-58.63.236.212-42038-443-6', 'Volvo Group', 'iX3 ', '6.8', '180', '360', '206', '560', 'Yes', 'RWD', 'Type 2 CCS', 'SUV', 'D', '68040', 'High'),
(5, '10.42.0.1-10.42.0.42-53-2400-17', 'Proterra', 'e ', '9.5', '145', '170', '168', '190', 'Yes', 'RWD', 'Type 2 CCS', 'Hatchback', 'B', '32997', 'Low'),
(6, '239.255.255.250-10.42.0.42-1900-57206-17', 'Renault ', 'Zoe ZE50 R135', '9.5', '140', '310', '168', '230', 'Yes', 'FWD', 'Type 2 CCS', 'Hatchback', 'B', '33133', 'High');
