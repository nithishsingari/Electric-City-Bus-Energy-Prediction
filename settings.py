...
ROOT_URLCONF = 'data_driven_energy_economy_prediction.urls'
...
WSGI_APPLICATION = 'data_driven_energy_economy_prediction.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'data_driven_energy_economy_prediction',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
