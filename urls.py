"""data_driven_energy_economy_predictionURL Configuration
...
from data_driven_energy_economy_prediction import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Energy_Economy_Type/$', remoteuser.Predict_Energy_Economy_Type, name="Predict_Energy_Economy_Type"),
    ...
    url(r'^View_Prediction_Of_Energy_Economy_Type_Ratio/$', serviceprovider.View_Prediction_Of_Energy_Economy_Type_Ratio, name="View_Prediction_Of_Energy_Economy_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Energy_Economy_Type/$', serviceprovider.View_Prediction_Of_Energy_Economy_Type, name="View_Prediction_Of_Energy_Economy_Type"),
